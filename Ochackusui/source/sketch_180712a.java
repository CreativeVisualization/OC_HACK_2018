...
public class sketch_180712a extends PApplet {
...
noLoop();
  ...
  noLoop();
  save("OChack"+str(PApplet.parseInt(random(65535)))+".png");
  
}
  public void settings() {  size(770, 990); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "sketch_180712a" };
    if (passedArgs != null) {
