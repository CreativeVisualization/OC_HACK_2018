...
float[][] inner = {
  {593.85, 564.37}, {583.25, 894.16}, {467.13, 738.6}, {315.13, 913.37}, {274.54, 746.57}, {87.85, 763.07}, {223.35, 583.99}, {67.92, 525.8}, {197.14, 428.81}, {41.06, 257.7}, {202.61, 228.05}, {173.31, 83.53}, {333.35, 164.55}, {421.95, 59.68}, {428.38, 193.}, {592.02, 67.39}, {471.06, 324.86}, {684.25, 269.7}, {592.2, 418.0}, {720.41, 598.34}
};
void setup() {
  size(1000, 1200, P3D);
  background(255);
